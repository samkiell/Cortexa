          ...
          >
            ...
            <div className="space-y-8 text-[14px] font-light text-white/40 leading-relaxed">
              ...
              <section className="space-y-3">
                ...
                <p>
                  Your data is used solely to provide and improve the Cortexa experience. We do not sell your personal information to third parties. Conversations are processed by our AI partners (like Venice AI) to generate responses.
                </p>
              </section>
